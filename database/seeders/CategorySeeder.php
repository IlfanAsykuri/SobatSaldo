...
class CategorySeeder extends Seeder
{
    public function run(): void
    {
        $categories = [
            // Pengeluaran
            ['name' => 'Makanan',     'type' => 'expense', 'is_default' => false,
             'keywords' => ['makan', 'nasi', 'warteg', 'warung', 'ayam', 'bakso', 'mie', 'soto', 'indomie', 'rendang', 'restoran']],

            ['name' => 'Minuman',     'type' => 'expense', 'is_default' => false,
            ...
            ['name' => 'Pemasukan Lain', 'type' => 'income', 'is_default' => false,
